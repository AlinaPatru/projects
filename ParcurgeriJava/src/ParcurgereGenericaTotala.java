...
public class ParcurgereGenericaTotala {

	public static void parcurgereGenerica(ArrayList<Arc> A,int nodSursa,int nrNoduri, ArrayList<Integer> U, ArrayList<Integer>  W, ArrayList<Integer>  V, ArrayList<Integer> o, ArrayList<Integer> p,ArrayList<Integer> N)
	{
	...
	public static void main(String[] args) 
	{
		...
		parcurgereGenerica(A,nodSursa,nrNoduri,U,W,V,o,p,N);
