...
public class ParcurgereInLatime 
{

	public static void parcurgereInLatime(ArrayList<Arc> A,int nodSursa,int nrNoduri, ArrayList<Integer> U, ArrayList<Integer>  W, ArrayList<Integer>  V, ArrayList<Integer> l, ArrayList<Integer> p,ArrayList<Integer> N)
	{
